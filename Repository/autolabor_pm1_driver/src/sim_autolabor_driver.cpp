...
#include "autolabor_pm1_driver/Encode.h"
#include "dynamic_reconfigure/server.h"
#include "autolabor_pm1_driver/SimAutolaborDriverConfig.h"
...
typedef autolabor_pm1_driver::SimAutolaborDriverConfig SimAutolaborDriverConfig;
typedef autolabor_pm1_driver::Encode Encode;
...
void SimpleDriver::send_callback(const ros::TimerEvent&){
  if (run_flag_){
    ...
    data[3] = msg_seq_++;
    data[5] = (send_right_ >> 8) & 0xff;
    data[6] = send_right_ & 0xff;
    data[7] = (send_left_ >> 8) & 0xff;
    data[8] = send_left_ & 0xff;
